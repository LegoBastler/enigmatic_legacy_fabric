package com.waka_coco_lego.enigmaticlegacy.objects;
...
//
    ...
    public int getFireImmunityTimerCap() {
        ...
        // TODO fix this once the BlazingCore is added
        // @OnlyIn(Dist.CLIENT)
    ...
    public void setSpellstoneCooldown(int spellstoneCooldown) {
        ...
        if (this.spellstoneCooldown != newValue) {
            ...
            for (Item spellstone : EnigmaticItems.SPELLSTONES) {
                this.player.get().getItemCooldownManager().set(spellstone, this.spellstoneCooldown);
            }
        }
    }

    // TODO fix this once ForbiddenFruit is added -> view encode method
